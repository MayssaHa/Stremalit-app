...
with col2:
    ...
    st.markdown(P, unsafe_allow_html=True)
    P= '<p style="color:#000000; text-align:left; position: absolute; top: 150px; line-height:1em; font-size: 17px; font-style:bold">The second crisis occurred in the beginning of 2020, when cases of Covid-19 first appeared in Tunisia. </p> <br> <br> <br>'
    st.markdown(P, unsafe_allow_html=True)

...
with col1:
    ...
    R1 = '<p style="color:#B56576; text-align:justify; position: absolute; top: 0px; font-size: 15px">Animation team ratings were excellent, both for the hotel and for the region in general. Nevertheless, less than 4% of guests noticed this excellent service. \nCustomers may be more concerned about the hotel s many poor services, hence the need to improve the poorly rated services and highlight the highly rated services.</p>'
...
with col5:
    ...
    st.markdown(P, unsafe_allow_html=True)
    R3 = '<p style="color:#B56576; text-align:justify; position: absolute; top: 0px; font-size: 15px">The most appreciated thing in this hotel and the region, is the pools and the beaches, and with high rates, (More than 20% of customers mentioned the pools and beaches). Thus, the hotel is still underrated compared to competing hotels in the same area. </p>'
...
P= '<p style="color:#000000; text-align:left; position: absolute; line-height:1.5em; font-size: 17px; font-style:bold">We observe a decreasing and seasonal phenomenon (decreasing trend), that lasts 5 years, starting from 2010. <br>And we notice 3 types of crises:</p>'
st.markdown(P, unsafe_allow_html=True)
col1, col2, col3=st.columns([0.5, 10,0.5])
with col1:
    st.empty() 
with col2:
    P= '<p style="color:#000000; text-align:left; position: absolute; top: 25px; line-height:1em; font-size: 17px; font-style:bold">The first crisis in 2011, is explained by the Tunisian revolution. </p>'
    st.markdown(P, unsafe_allow_html=True)
    P= '<p style="color:#000000; text-align:left; position: absolute; top: 25px; line-height:1em; font-size: 17px; font-style:bold">The second crisis in 2015, which extends over a period of 4 years, is explained by the terrorist events that took place in Tunisia, and more specifically the terrorist attack of June 26, 2015 in Sousse, which also affected tourism throughout Tunisia. </p>'
    st.markdown(P, unsafe_allow_html=True)
    P= '<p style="color:#000000; text-align:left; position: absolute; top: 60px; line-height:1em; font-size: 17px; font-style:bold">Recently, we have experienced a crisis of Covid-19, <br>We actually notice at the beginning a slight increase in the number of customers, and at the end of 2019, early 2020 appear the first cases of Covid in Tunisia, and this number drops to zero once again. </p>'
    st.markdown(P, unsafe_allow_html=True)
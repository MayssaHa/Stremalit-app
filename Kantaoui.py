...
P= '<p style="color:#000000; text-align:left; position: absolute; line-height:1.5em; font-size: 17px; font-style:bold">We observe a decreasing and seasonal phenomenon (decreasing trend), that lasts 5 years, starting from 2010. <br>And we notice 3 types of crisis:</p>'
st.markdown(P, unsafe_allow_html=True)
